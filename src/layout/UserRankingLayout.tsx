      ...
      <div className="mt-6 px-2 overflow-x-auto flex flex-col lg:flex-row items-center md:items-start justify-between gap-8 w-full">
        <div className="max-w-[340px] w-full flex gap-4 justify-between items-center">
          <select
            ...
            className="outline-none text-primary font-semibold bg-offwhite border border-solid border-[#DBDBDB] rounded-2xl p-3 w-[150px]"
          >
          ...
          <select className="outline-none text-primary font-semibold bg-offwhite border border-solid border-[#DBDBDB] rounded-2xl p-3 w-[150px]">
